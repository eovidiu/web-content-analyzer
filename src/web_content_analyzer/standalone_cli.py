"""Standalone CLI that doesn't depend on CrewAI."""
...
from .simple_analyzer import SimpleWebContentAnalyzer
...
def main(ctx, verbose):
    """Web Content Analyzer - Extract keywords from web pages using Claude API."""
...
def server(port: int, host: str):
    ...
    click.echo("Server mode is not yet implemented. Use 'analyze' or 'batch' commands for now.")
    sys.exit(1)
